...
For these reasons, these are important to know the start point of perturbation and how much elements affected from change. In this way, we deveoped the `calc_perturbation()` and `find_node_perturbation()` functions in `regulationSimulatoR` package.
