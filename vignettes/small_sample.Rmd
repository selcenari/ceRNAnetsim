...
In this vignette, the model functions are demonstrated with minimal sample dataset. Dataset *minsamp* includes miRNA:target interaction factors in addition to basic_data in [basic usage of package](https://selcenari.github.io/ceRNAnetsim/articles/basic_usage.html). *minsamp* is a sample dataset that includes 6 genes, 2 miRNAs and interaction factors of miRNA:gene pairs.
...
```{r echo=FALSE, fig.align='center', fig.width=6, fig.height=5, dpi=120}
