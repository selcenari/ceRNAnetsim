...
The dataset `basic_data` is constructed in [previous vignette](https://selcenari.github.io/ceRNAnetsim/articles/basic_usage.html). We can improve this dataset to obtain *minsamp* dataset as following.
...
By joining these tables, your data will be ready for analysis.

```{r}
basic_data%>%
   inner_join(interaction_complex, by= c("competing", "miRNA"))
```
