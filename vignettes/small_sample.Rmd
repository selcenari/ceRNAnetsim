...
<!-- #TODO in convenient_iteration.Rmd vignette, the animated gif /gifs/con_iter_chunk3.gif shows there's change in expression at each cycle, but actually there's no change after cycle 3 for Gene4, is it due to `limit=0` case? -->
