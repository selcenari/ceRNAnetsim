...
No, actually here we take account entire interaction factors. So, there are two different command in these vignettes. It just might be due to the fact that the system provides steady-state early when we use the interaction factors in priming_graph function. -->
