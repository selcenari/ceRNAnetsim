...
<!-- yes, I also did not understand why it occur, when I processed the dataset. In chunk 9, you can see that dataset contains 2 expression values for 3 genes. If you have an advice, I can try. -->
