...
This vignette is about the integration of gene miRNA pairs and their expression dataset and analysis. Let's try to analysis of these dataset with `regulationSimulatoR`. First of all, obtain the datasets for analysis:
