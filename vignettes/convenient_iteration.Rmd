---
title: "A Suggestion: How to Find the Appropriate Iteration for Simulation"
author: "Selcen Ari"
date: "`r Sys.Date()`"
...
In the `ceRNAnetsim` package, regulations of miRNA:target pairs are observed via direct or indirect interactions of elements in network. In this approach, change in expression level of single gene or miRNA can affect the whole network like water wave. So, when the change is applied the system, it affects to primary neighborhood firstly, and then the secondary. 
...
![Midsamp Gene17 perturbation with 15 iteration](gifs/con_iter_chunk4.gif)
...
## Let's try the suggestion of `iteration_graph` for Gene17.
