...
<!-- #TODO now the function is modular so it's possible to do "update_variables(current_counts = new_counts)" approach as well, we can prepare a small example about that -->
